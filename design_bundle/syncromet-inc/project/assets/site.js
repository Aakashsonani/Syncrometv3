...
(function () {
  ...
  var I = {
    logo: '<svg viewBox="0 0 24 24" fill="none" stroke="#d27e4b" stroke-width="1.8" stroke-linecap="round" stroke-linejoin="round"><path d="M3 7l9-4 9 4-9 4-9-4z"/><path d="M3 12l9 4 9-4M3 17l9 4 9-4" stroke="#9fb0bd"/></svg>',
  ...
  var NAV = [
    ...
    { label: "Safety & Environment", href: "safety.html" },
    { label: "Blog", href: "blog.html" },
    { label: "FAQ", href: "faq.html" },
    { label: "Contact", href: "contact.html" }
  ];

  var PHONE = "1-888-555-7625";
  var PHONE_TEL = "+18885557625";
  var EMAIL = "trade@syncromet.ca";

  function currentPage() {
    var p = location.pathname.split("/").pop();
    return p && p.length ? p : "modern.html";
  }
  ...
  function buildHeader() {
    ...
    return '' +
      '<header class="site-header" id="siteHeader"><div class="wrap"><nav class="nav" aria-label="Primary">' +
        '<a class="brand" href="modern.html" aria-label="Syncromet home">' +
      ...
      '<div class="mobile-drawer" id="mobileDrawer">' +
        ...
        '<div class="mobile-drawer__panel">' +
          '<div class="mobile-drawer__head">' +
            '<a class="brand" href="modern.html"><span class="brand__mark">' + I.logo + '</span><span class="brand__name">SYNCRO<b>MET</b></span></a>' +
    ...
    '<footer class="site-footer"><div class="wrap">' +
      '<div class="footer-grid">' +
        '<div class="footer-about">' +
          '<a class="brand" href="modern.html"><span class="brand__mark">' + I.logo + '</span><span class="brand__name" style="color:#fff">SYNCRO<b>MET</b></span></a>' +
          '<p>Canada&rsquo;s trusted partner in ferrous and non-ferrous scrap metal trading. Transparent grading, competitive pricing, and responsible recycling since 1998.</p>' +
          '<div class="social">' +
        ...
        '</ul></div>' +
        '<div><h4>Contact</h4>' +
          '<div class="footer-contact-row">' + I.pin + '<span>1450 Foundry Road, Unit 12<br>Mississauga, ON L5T 2H7</span></div>' +
          '<div class="footer-contact-row">' + I.phone + '<a href="tel:' + PHONE_TEL + '">' + PHONE + '</a></div>' +
